...
public class Edad {
    public static void main(String[] args) {
        ...
        if(asistencia>75 && calificación>=80){
            ...
            if(asistencia<=75){
                System.out.println("No cumpliste el requisito de la asistencia. No pasas el diplomado.");
            }else{
                System.out.println("No cumpliste el requisito de la calificacion. No pasas el diplomado.");
            }
        }
        entrada.close();
